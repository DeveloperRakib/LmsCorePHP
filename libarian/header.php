        ...
        <div class="page-header">
            ...
            <div class="rightside-header">
                ...
                <div class="header-section" id="user-headerbox">
                    ...
                    <div class="user-options dropdown-box">
                        <div class="drop-content basic">
                            <ul>
                                <li> <a href="../asset/pages_user-profile.html"><i class="fa fa-user" aria-hidden="true"></i> Profile</a></li>
                                <li> <a href="../asset/pages_lock-screen.html"><i class="fa fa-lock" aria-hidden="true"></i> Lock Screen</a></li>
                                <li><a href="../asset/#"><i class="fa fa-cog" aria-hidden="true"></i> Configurations</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="header-section">
                    <a href="../asset/pages_sign-in.html" data-toggle="tooltip" data-placement="left" title="Logout"><i class="fa fa-sign-out log-out" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
        <!-- page BODY -->
                    ...
                    <div class="nano-content">
                        <nav>
                            <ul class="nav nav-left-lines" id="main-nav">
                                ...
                                <li class="<?= $page=='student.php' ? 'active-item':'' ?>" ><a href="student.php"><i class="fa fa-users" aria-hidden="true"></i><span>Student</span></a></li>
                               
                                <li class="has-child-item close-item <?= $page=='addbooks.php' ? 'open-item':'' ?> <?= $page=='managebooks.php' ? 'open-item':'' ?>">
                                ...
                                <li class="<?= $page=='issu_books.php' ? 'active-item':'' ?>"><a href="issu_books.php"><i class="fa fa-home" aria-hidden="true"></i><span>Issubooks</span></a></li>
